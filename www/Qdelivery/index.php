...
<section class="qd_destaque">
    ...
    <div class="swiper home-slider">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide" style="background: url(assets/img/slides/slide1.png) no-repeat;">
                <div class="content">
            ...
            <div class="swiper-slide slide" style="background: url(assets/img/slides/slide2.png) no-repeat;">
                <div class="content">
                    <h3> A <span>melhor</span> quentinha <br> da cidade</h3>
                    <a href="" class="btn">Comprar agora </a>
                </div>
...
<section class="destaque">
    <div class="box-container">
        ...
        <div class="box">
            <div class="qdimg">
                <img src="assets/img/destaques/1.png" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="qdimg">
                <img src="assets/img/destaques/2.png" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="qdimg">
                <img src="assets/img/destaques/3.png" alt="">
            </div>
            <div class="content">
...
<div class="como-funciona">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="assets/img/como-funciona/1.png"  alt="">
        ...
        <div class="box">
            <img src="assets/img/como-funciona/2.png"  alt="">
        ...
        <div class="box">
            <img src="assets/img/como-funciona/3.png"  alt="">
        ...
        <div class="box">
            <img src="assets/img/como-funciona/4.png"  alt="">
            <h3>Bom apetite</h3>
        </div>
        <!-- FIM ITEM COMO FUNCIONA O -->
...
<section class="loja">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="assets/img/quentinha2.png" width="190px" alt="">
            <h3>QUENTINHA G</h3>
...
<section class="empresa">
    <div class="row">
        <div class="empresa-img">
            <img src="assets/img/empresa_video.gif" alt="780x900">
        </div>
        <div class="content">
